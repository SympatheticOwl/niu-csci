...
<html>
	...
	<body>
	<!--html page head-->
	<h1 align="center">Search By Contributor</h1>
	
	<form method="POST" action="">
		<!-- Owner Number:	<input type="text" name="OwnerNumber"/></br> -->
		Contributor Name:		<input type="text" name="aName"/>
		<input type="submit" name="submit" value="Submit"/>
		<input type="button" name="reset" value="Reset" onclick="window.location.href='http://students.cs.niu.edu/~z1761739/gp/gp_p4.php'"/>
	</form>
	</br>
		...
		try{			
			//if($_POST['submit']){
				...
				$sql =  "select * from Songs inner join Contributors on Songs.artist = Contributors.band where name Like :keywrd;";
...
drop down to select user ID

premium query order by payment
standard query ordered by time
public query ordered by payment and time
-->